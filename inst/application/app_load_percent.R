...
server <- function(input, output) {
  ...
  # Create a common hostess loader
  loader <- hostess_loader(stroke_color = "red")

  # Create the hostess and set loader
  hostess1 <- Hostess$new()$set_loader(loader)
  hostess2 <- Hostess$new()$set_loader(loader)
  hostess3 <- Hostess$new()$set_loader(loader)
  hostess4 <- Hostess$new()$set_loader(loader)
  hostess5 <- Hostess$new()$set_loader(loader)
  hostess6 <- Hostess$new()$set_loader(loader)

  # Set the loader as html
  waiter <- Waiter$new(
    c("condition1_chromPlot",
