...
server <- function(input, output) {
  ...
  observe({
    ...
    vals$point_size_2 <- input$point_size_2
    vals$point_size_3 <- input$point_size_3
    vals$point_size_4 <- input$point_size_4
    vals$point_color_1 <- input$point_color_1
    vals$point_color_2 <- input$point_color_2
    vals$text_size_1 <- input$text_size_1
    vals$text_size_2 <- input$text_size_2
    vals$text_size_3 <- input$text_size_3
    vals$text_size_4 <- input$text_size_4
  ...
  output$render_ui_1 <- renderUI({
    list(
      ...
      selectInput(
        ...
        label = 'Condition 1 color',
        choices = colors(),
        selected = "red3"
      ),
      selectInput(
        inputId = 'point_color_2',
        label = 'Condition 2 color',
        choices = colors(),
        selected = "black"
      ),
      numericInput(
